...
This repository contains the source of the public documentation site, live at **[docs.lendwise.fi](https://docs.lendwise.fi)**.
...
1. **[What is Lendwise](https://docs.lendwise.fi/guide/what-is-lendwise)** — the problem it solves and how it solves it.
2. **[Getting started](https://docs.lendwise.fi/guide/getting-started)** — open the app, filter markets, read rates correctly. No wallet or account needed for research.
3. **[The optimizer](https://docs.lendwise.fi/guide/optimization)** — turn comparable rates into an allocation, based on your risk profile and investment horizon.
4. **[Data & methodology](https://docs.lendwise.fi/guide/methodology)** — where every number comes from: sources, update cadence, and exactly how net APY is computed.

## Explore the docs

| Section | What you'll find |
| --- | --- |
| [Guide](https://docs.lendwise.fi/guide/what-is-lendwise) | Product walkthrough — concepts, app usage, optimizer, methodology |
| [GraphQL API](https://docs.lendwise.fi/api/) | Free public API for the full standardized dataset — hourly/daily APY, rate breakdowns, market state. No API key needed |
| [Learn](https://docs.lendwise.fi/learn/) | Educational articles on DeFi lending and yield — protocol comparisons, why the same asset yields differently across markets |
| [Research](https://docs.lendwise.fi/research/) | Original research on yield dispersion across DeFi lending markets |

**Builders:** the [GraphQL API](https://docs.lendwise.fi/api/) exposes the same data that powers the app at `https://lendwise.fi/api/graphql`, with an interactive GraphiQL explorer — just open the endpoint in a browser.
